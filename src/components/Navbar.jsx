...
function Navbar() {
  ...
  const downloadResume = () => {
    window.open('https://drive.google.com/file/d/135L1FFCuQzNzd7oXGSRrhDDdCrHR_2c5/view?usp=sharing', '_blank');
  };
  useEffect(() => {
  ...
  return (
    <div className="sticky top-0 z-50 navbar bg-blue-700">
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-blue-700 text-white rounded-box w-52">
		...
		<li><a href="#experience" className="nav-link">
          Experience
        </a></li>
    ...
    <a href="#" className="btn btn-ghost normal-case nav-link text-white text-xl">SHANMUGAM R</a>
  </div>
